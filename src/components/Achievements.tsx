...
import { Code2, GraduationCap, Flame, Sparkles, Trophy } from 'lucide-react';
...
const achievements = [
  ...
  },
  {
    ...
    desc: "Independently upskilled in Generative AI techniques, Large Language Models prompting, Retrieval-Augmented Generation, and Python data pipelines.",
    icon: Sparkles,
...
export default function Achievements() {
  return (
    <section id="achievements" className="py-28 relative z-10 px-6 max-w-7xl mx-auto">
      {/* Section Header */}
      <div className="text-center space-y-4 mb-20">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neon-pink/10 border border-neon-pink/30 text-neon-pink text-xs font-mono font-semibold">
          ...
          return (
            ...
            >
              <Interactive3DCard
                maxTilt={10}
                glowColor={ach.glow}
                className="glass-card p-6 md:p-8 rounded-2xl flex flex-col sm:flex-row gap-5 items-start border border-white/10 h-full"
              >
                {/* Animated Icon Frame */}
